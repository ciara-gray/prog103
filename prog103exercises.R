...
age_class_function <- function(age_class) {
  if (age_class == "egg") {
    y <- 10
  } else if (age_class == "larva") {
    y <- 5
...
age_class_function("egg")
age_class_function("larva")
age_class_function("adult")
age_class_function("senescent")
